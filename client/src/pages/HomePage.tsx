...
export default function HomePage() {
  const { products, loading, togglePublish } = usePublishedProducts();
          ...
          {loading ? (
            ...
            <Card className="bg-transparent border-none text-center">
              <CardContent className="space-y-2">
                <h2 className="text-xl font-semibold">No {tab} products</h2>
                <p className="text-gray-500 text-sm">
                  {tab === "published" ? "No published products available" : "No unpublished products available"}
                </p>
              </CardContent>
            </Card>
          )}
