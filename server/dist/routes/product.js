...
product.get("/all", productController_1.getAllProducts);
product.get("/published", middleware_1.protect, productController_1.getPublishedProducts);
product.delete("/:id", middleware_1.protect, productController_1.deleteProduct);
product.patch("/:id/publish", middleware_1.protect, productController_1.publishProduct);
